...
$cekuser = mysqli_query($koneksi, "SELECT *, l.level as levelnya FROM usr_ambar u,level l WHERE u.id_level = l.id_level AND u.id_user='$iduser'");

$row=mysqli_fetch_array($cekuser);

$namauser=$row['nama_user'];
$levelnya=$row['levelnya'];
