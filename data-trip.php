            ...
            <div class="page-sidebar">
                ...
                <ul class="x-navigation">
                    <li class="xn-profile">
                        ...
                        <div class="profile">
                            <div class="profile-image">
                                <img src="img/trukk.jpg" width="100px" alt="John Doe"/>
                            </div>
                    ...
                    <li class="xn-openable">
                        ...
                        <ul>
                            <li><a href="data-trip.php"><span class="fa fa-table"></span> Data Trip</a></li>
            ...
            <div class="page-content">
               ...
               <!-- START X-NAVIGATION VERTICAL -->
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="active">Data Trip Hari ini</li>
                </ul>
                <!-- END BREADCRUMB -->

                <!-- PAGE TITLE -->
                <div class="page-title">
                    <h2><span class=""></span> Data Trip</h2>
                </div>
                <!-- END PAGE TITLE -->
